...
int main()
{
	...
	/*
		Calculate the average. Divise by 3 because
		the lowest test scores was dropped
	*/
...
// arguments. Its prompts the user to enter test scores,
...
double getLowest(const double array[], int size)
{
	...
	// Get the furst array's first element
	lowest = array[0];
